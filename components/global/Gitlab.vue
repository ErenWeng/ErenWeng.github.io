<template>
  <svg
    ...
    y="0px"
    viewBox="0 0 586 559"
    style="enable-background: new 0 0 586 559"
    xml:space="preserve"
  >
    <style type="text/css">
      .st0 {
    ...
    >
      <path
        ...
        class="st15"
        d="M0,0.5v124h586V0.5H0L0,0.5z"
      />
      <path
        id="path40_115_"
        sketch:type="MSShapeGroup"
        class="st15"
        d="M0,435.5v124h586v-124H0L0,435.5z"
      />
      <path
        id="path40_114_"
        sketch:type="MSShapeGroup"
        class="st15"
        d="M462.2,560h124V0h-124V560L462.2,560z"
      />
      <g class="st16">
        <text transform="matrix(1 0 0 1 511.2881 283.332)" class="st18 st19">
          1x
        </text>
      </g>
      <g class="st16">
        <text transform="matrix(1 0 0 1 281.2881 500.9979)" class="st18 st19">
          1x
        </text>
      </g>
      <g class="st16">
        <text transform="matrix(1 0 0 1 281.2881 65.9981)" class="st18 st19">
          1x
        </text>
      </g>
      <path
        ...
        sketch:type="MSShapeGroup"
        class="st15"
        d="M0,560h124V0H0V560L0,560z"
      />
      <g class="st16">
        <text transform="matrix(1 0 0 1 51.2881 283.332)" class="st18 st19">
          1x
        </text>
      </g>
    </g>
